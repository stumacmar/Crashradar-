...
// Build data/fred_cache.json for Economic Crash Radar Pro
...
(async () => {
  try {
    ...
    // Series required by index.html (plus safe extras)
    const SERIES = {
      // Core (must exist for indicators)
      T10Y3M:       "1959-01-01", // Yield curve (10y-3m)
      BAMLH0A0HYM2: "1997-01-01", // HY credit spread
      UMCSENT:      "1978-01-01", // UMich Sentiment
      NAPMNOI:      "1948-01-01", // ISM New Orders
      ...
      // Extras (not strictly required but fine to have)
      UNRATE:       "1948-01-01",
      INDPRO:       "1919-01-01",
      NFCI:         "1971-01-01",
      VIXCLS:       "1990-01-01",
